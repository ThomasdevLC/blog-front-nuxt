  ...
  <NuxtLink :to="`/article/${remainingArticle.id}`">
    <div class="group">
      ...
      <div class="pt-5">
        ...
        <h2 class="font-cormorant text-gray-900 font-semibold text-3xl mt-2">{{ remainingArticle.title }}</h2>
        <p class="mt-2">
...
const imageUrl = computed(() => import.meta.env.VITE_API_URL + props.remainingArticle.image.formats.medium.url);
</script>
